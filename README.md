...
### 2.1 This Repository
All of the materials for the module this semester will appear in this
repository. You can also access them via the links on Blackboard, but the
advantage of storing the actual files here is that you can clone this repository
onto your own machine and on Codio. 
...
You need to get Codio setup so that you can develop your team project and run
the code examples in this repository. To do this, follow the instructions on
the [Setting Up Codio](./setting-up-codio.md) page.

### 2.3 If You Encounter Technical Problems and What To Do About Them

If you encounter technical problems or issues, check out the [Technical
FAQ](technical-faq.md). 

You can also ask one of the teaching staff in or after a lecture, or in a
practical class, or use the Discussion Forum on Blackboard. (Try to make sure
your question isn't already addressed in the FAQ though &mdash; or, if it is,
you've given following the instructions in the answer a go.) Either way, we're a
...
Materials for the module can all be found in this repository, which consists of
directories corresponding to content for each week. Files will be added as we
proceed through the module.

If you've cloned this repository, you can just do a `git pull` each week to get
the new materials. 

Lecture and practical content for this module is front-loaded in weeks 1&ndash;5
...
|3     |  <strong>Forms and Sessions</strong><ul><li><a href="slides/w3-forms.pdf">Forms &mdash; the basics</a></li><li><a href="slides/w3-sanitisation-and-validation.pdf">Sanitisation & Validation</a></li><li><a href="slides/w3-forms-get-and-post.pdf">GET and POST</a></li><li><a href="slides/w3-sessions.pdf">Sessions</a></li></ul> <strong>Databases</strong><ul><li>[An Introduction to Databases and Why We Need Them](slides/w3-databases.pdf)</li></ul> | Code Jam |Sprint 1 |  |
|4     | <strong>Databases Continued</strong><ul><li>Object Relational Mapping</li><li>Data Confidentiality</li></ul> | Code Jam | Sprint 2 |  |
...
Lecture Theatre 3** in weeks 1&ndash;5. 

There will be a break during 2 hour lectures, and also a (non-assessed) team
...
Here, you can talk to us about any technical problems you're experiencing with
