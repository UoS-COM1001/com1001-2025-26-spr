...
|-:|-|-|-|-|
|1     | <strong>Hello!</strong><ul><li><a href="slides/w1-intro.pdf" target="_blank">Introduction to the Spring Semester</a></li><li>[The Group Project in the Spring Semester](slides/w1-DS-team-project.pdf)</li><li>Is Software Engineering Dead?</li></ul> | Code Jam |  |  |
